...
def get_focus_menu_keyboard() -> InlineKeyboardMarkup:
    ...
    builder.row(InlineKeyboardButton(text="🚀 Начать фокус", callback_data="start_focus"))
    builder.row(
    ...
    builder.row(InlineKeyboardButton(text="❓ Помощь", callback_data="focus_help"))
...
def get_focus_settings_keyboard(settings: Dict[str, Any]) -> InlineKeyboardMarkup:
    ...
    builder.row(
        InlineKeyboardButton(
            text=f"⏱ Работа: {settings['work_duration']} мин", callback_data="set_duration:work"
        )
    )
    builder.row(
        InlineKeyboardButton(
    ...
    builder.row(
        InlineKeyboardButton(
            text=f"🔄 Авто-перерыв: {auto_break_emoji}", callback_data="toggle_auto_break"
        )
    )

    builder.row(InlineKeyboardButton(text="🔙 Назад", callback_data="focus"))
...
def get_duration_presets_keyboard(duration_type: str, presets: List[int]) -> InlineKeyboardMarkup:
    ...
    for minutes in presets:
        buttons.append(
            InlineKeyboardButton(
                text=f"{minutes} мин", callback_data=f"duration:{duration_type}:{minutes}"
            )
        )
    ...
    builder.row(InlineKeyboardButton(text="🔙 Назад", callback_data="focus_settings"))
...
def get_stats_period_keyboard() -> InlineKeyboardMarkup:
    ...
    builder.row(InlineKeyboardButton(text="📅 Сегодня", callback_data="stats_period:today"))
    builder.row(InlineKeyboardButton(text="📅 За неделю", callback_data="stats_period:week"))
    builder.row(InlineKeyboardButton(text="📅 За месяц", callback_data="stats_period:month"))
    builder.row(InlineKeyboardButton(text="📅 За всё время", callback_data="stats_period:all"))
    builder.row(InlineKeyboardButton(text="🔙 Назад", callback_data="focus"))
...
def get_session_complete_keyboard() -> InlineKeyboardMarkup:
    ...
    builder.row(InlineKeyboardButton(text="🚀 Новая сессия", callback_data="start_focus"))
    builder.row(InlineKeyboardButton(text="📊 Статистика", callback_data="focus_stats"))
    builder.row(InlineKeyboardButton(text="🔙 В меню", callback_data="focus"))
