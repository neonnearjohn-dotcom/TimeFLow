...
class AssistantProfileDB:
    ...
    async def save_onboarding_answer(self, telegram_id: int, qid: str, answer: Any) -> bool:
        """
    ...
    async def finalize_onboarding(
        ...
        try:
            ...
            if constraints:
                ...
                update_data["ai_profile.constraints.daily_time_minutes"] = constraints.get(
                    "daily_time_minutes", 60
                )
                update_data["ai_profile.constraints.working_days"] = constraints.get(
    ...
    async def save_plan(self, telegram_id: int, plan: Dict[str, Any]) -> bool:
        """
    ...
    async def update_progress(self, telegram_id: int, patch: Dict[str, Any]) -> bool:
        """
    ...
    async def update_preferences(self, telegram_id: int, preferences: Dict[str, Any]) -> bool:
        """
    ...
    async def add_risk(self, telegram_id: int, risk: Dict[str, Any]) -> bool:
        """
    ...
    async def update_task_status(
        self, telegram_id: int, task_id: str, status: str, notes: Optional[str] = None
    ) -> bool:
        """
