...
def test_keyboards():
    ...
    # Тест трекера
    try:
        from keyboards.tracker import tracker_menu_kb, habits_menu_kb, bad_habits_menu_kb
    ...
    # Тест фокуса
    try:
        from keyboards.focus import focus_menu_kb, session_control_kb, settings_menu_kb
    ...
    # Тест чек-листа
    try:
        from keyboards.checklist import checklist_menu_kb, priority_selection_kb, tasks_list_kb
    ...
    # Тест профиля
    try:
        from keyboards.profile import profile_menu_kb, achievements_menu_kb, points_history_kb
    ...
    # Тест ассистента
    try:
        from keyboards.assistant import assistant_menu_kb, assistant_chat_kb, continue_chat_kb
